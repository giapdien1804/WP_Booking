    ...
    <div class="content">
        ...
        <div class="container content-responsive-img margin-bottom-50">
            ...
            <div class="tour-search-box margin-bottom-30">
                <span>Filter: </span>
                <?php
                $name = esc_html($_GET['s']) != '' ? esc_html($_GET['s']) : '';
                ...
                $search_link = "&s={$name}&tour_search_location={$get_location}&tour_search_price_range={$get_price}&tour_search_howlong={$get_duration}";
            ...
            <?php else: ?>
                <div class="not-found-tailor">
                    <h3 class="margin-bottom-30">Nothing tour found.</h3>
                    <h1 class="title-category text-capitalize text-bold">Create your trip now</h1>
                    <hr class="hr-cate">
